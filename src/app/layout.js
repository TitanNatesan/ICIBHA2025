...
export const metadata = {
  title: "KAHE Conference",
  description:
    "2nd National Level Conference on Intelligent Biosystems for Healthcare Analytics",
};
